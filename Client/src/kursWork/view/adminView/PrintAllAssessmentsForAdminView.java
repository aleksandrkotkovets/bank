...
public class PrintAllAssessmentsForAdminView extends JFrame {
    public static PrintAllAssessmentsForAdminView jframe;
    ...
    public PrintAllAssessmentsForAdminView(Controller controller) {
        jframe = this;
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) {
                    ...
                    String assessments = (String) tableModel.getValueAt(row,3);
    ...
    private void backToMainAdminView() {
        controller.backToMainAdminViewFromAssessmentsView();
    }
}
